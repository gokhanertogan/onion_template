...
var serviceName = builder.Configuration["Service:Name"] ?? "api-gateway";
...
{
    var basketApiBaseUrl = builder.Configuration["Downstream:BasketApiBaseUrl"] ?? "http://localhost:5001";
